        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex-1"><label className="text-xs text-gray-400 uppercase">Gender</label>{isEditingDetails ? <select className="w-full border-b" value={(patient.gender && patient.gender !== "Unknown") ? patient.gender : "Male"} onChange={e => setPatient({ ...patient, gender: e.target.value })}><option>Male</option><option>Female</option><option>Other</option></select> : <p>{(patient.gender && patient.gender !== "Unknown") ? patient.gender : "-"}</p>}</div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div><label className="text-xs font-bold text-gray-400 uppercase">Location</label>{isEditingDetails ? <input className="w-full border-b" value={patient.location || ""} onChange={e => setPatient({ ...patient, location: e.target.value })} /> : <p>{patient.location || "-"}</p>}</div>
                </div>
